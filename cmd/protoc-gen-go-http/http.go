...
const (
	...
	transportHTTPPackage = protogen.GoImportPath("github.com/thoohv5/common/transport/http")
	bindingPackage       = protogen.GoImportPath("github.com/thoohv5/common/transport/http/binding")
)
